...
private:
  ...
  *
  * A pickup action with the tablebot consists of sequentially executing the following actions: move to approach angle,
  ...
  *
  * A store action with the tablebot consists of moving the end effector above the storage location,
